...
import org.monora.uprotocol.client.android.protocol.communication.NotAllowedException
        ...
        private fun handleRequest(
            ...
            when (response.getString(Keyword.REQUEST)) {
                ...
                Keyword.REQUEST_CLIPBOARD -> {
                    val textStreamObject = SharedTextModel(0, response.getString(Keyword.TRANSFER_TEXT))

                    appDatabase.sharedTextDao().insertAll(textStreamObject)
