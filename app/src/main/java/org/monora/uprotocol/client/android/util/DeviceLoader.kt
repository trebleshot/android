...
import org.monora.uprotocol.client.android.protocol.DeviceBlockedException
import org.monora.uprotocol.client.android.protocol.DeviceInsecureException
...
object DeviceLoader {
    ...
    fun load(kuick: Kuick, address: InetAddress, listener: OnResolvedListener?) {
        Thread {
            try {
