 ...
 */
package org.monora.uprotocol.client.android.ui.callbackimport
 ...
 * date: 14/04/18 15:59
 */
class SharingActionModeCallback<T : ContentModel?> { /*extends EditableListFragment.SelectionCallback<T>
{
