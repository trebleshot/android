 ...
 */
class MemberNotFoundException(member: TransferMember) :
    ReconstructionFailedException("Member with deviceId=" + member.deviceId + " and transferId=" + member.transferId + " is not valid") {
    var member: TransferMember
