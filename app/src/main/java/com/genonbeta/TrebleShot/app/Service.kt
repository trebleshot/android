...
abstract class Service : Service() {
    ...
    val notificationUtils: NotificationUtils
        get() {
            if (mNotificationUtils == null) mNotificationUtils =
                NotificationUtils(applicationContext, kuick, defaultPreferences)
            return mNotificationUtils!!
        }
    val selfApplication: App?
        get() = if (application is App) application as App else null
}