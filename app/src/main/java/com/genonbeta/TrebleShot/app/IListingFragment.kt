...
interface IListingFragment<T : ContentModel, V : ViewHolder> : ListingFragmentBase<T> {
    ...
    fun setLayoutClickListener(clickListener: ListingFragment.LayoutClickListener<V>?)
}