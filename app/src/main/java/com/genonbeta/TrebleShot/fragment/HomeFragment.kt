...
class HomeFragment : Fragment(), SnackbarPlacementProvider, TitleProvider, OnBackPressedListener {
    ...
    private lateinit var pagerAdapter: SmartFragmentPagerAdapter
    ...
    override fun onCreateView(
        ...
        pagerAdapter = SmartFragmentPagerAdapter(requireContext(), childFragmentManager)
        pagerAdapter.add(
            StableItem(
        ...
        pagerAdapter.add(StableItem(3, TextStreamListFragment::class.qualifiedName!!, null))
