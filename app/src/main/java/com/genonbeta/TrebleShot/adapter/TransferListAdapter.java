    ...
    public void onBindViewHolder(@NonNull final GroupEditableListAdapter.GroupViewHolder holder, int position)
    {
        try {
            ...
            if (!holder.tryBinding(object)) {
                ...
                String membersText = object.getMemberAsTitle(getContext());
                ...
                statusLayoutWeb.setVisibility(object.hasOutgoing() && object.transfer.isServedOnWeb ? View.VISIBLE
                        : View.GONE);
                text1.setText(FileUtils.sizeExpression(object.bytesTotal(), false));
                text2.setText(membersText.length() > 0 ? membersText : getContext().getString(
                        object.transfer.isServedOnWeb ? R.string.text_transferSharedOnBrowser : R.string.text_emptySymbol));
