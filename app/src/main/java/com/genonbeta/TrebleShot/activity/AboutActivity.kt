...
class AboutActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.activity_about_option_fourth_layout).setOnClickListener { view: View? ->
            if (Flavor.googlePlay == AppUtils.getBuildFlavor()) {
                ...
                this@AboutActivity, Updates.getDefaultUpdater(
                    this@AboutActivity
                ), true, null
            )
        }
    ...
    override fun onResume() {
        ...
        if (Flavor.googlePlay != AppUtils.getBuildFlavor()
            ...
            findViewById<TextView>(R.id.activity_about_option_fourth_text),
            Updates.getAvailableVersion(applicationContext)
        )
    }

    private fun highlightUpdater(textView: TextView, availableVersion: String) {
        textView.setTextColor(
            ContextCompat.getColor(
                applicationContext, AppUtils.getReference(
                    this@AboutActivity, R.attr.colorAccent
                )
            )
        )
