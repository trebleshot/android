...
class FileExplorerActivity : Activity() {
    private var mFragmentFileExplorer: FileExplorerFragment? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_file_explorer)
        val toolbar = findViewById<Toolbar>(R.id.toolbar)
        setSupportActionBar(toolbar)
        mFragmentFileExplorer = supportFragmentManager
            .findFragmentById(R.id.activity_file_explorer_fragment_files) as FileExplorerFragment?
    ...
    override fun onBackPressed() {
        if (!mFragmentFileExplorer.onBackPressed()) super.onBackPressed()
    }
    ...
    private fun openFolder(requestedFolder: DocumentFile?) {
        if (requestedFolder != null) mFragmentFileExplorer.requestPath(requestedFolder)
    }
