...
abstract class FileListFragment : EditableListFragment<FileHolder, ViewHolder, FileListAdapter>() {
    ...
    companion object {
        ...
        fun <T : ContentModel> shortcutItem(fragment: EditableListFragmentBase<T>, holder: FileHolder) {
