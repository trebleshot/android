...
open class TransferItemListFragment : EditableListFragment<GenericItem, ViewHolder, TransferItemListAdapter>(),
    TitleProvider, OnBackPressedListener {
    override fun onBackPressed(): Boolean = false

    override fun performDefaultLayoutClick(holder: ViewHolder, target: GenericItem): Boolean = false

    override fun getDistinctiveTitle(context: Context): CharSequence = javaClass.simpleName
