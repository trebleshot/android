...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private class WrappedCallback implements BarcodeView.Callback {
        private BarcodeView.Callback delegate;

        public WrappedCallback(BarcodeView.Callback delegate) {
    ...
    /**
     * @see BarcodeView#decodeSingle(BarcodeView.Callback)
     */
    public void decodeSingle(BarcodeView.Callback callback) {
        barcodeView.decodeSingle(new WrappedCallback(callback));
    }

    /**
     * @see BarcodeView#BarcodeView.Callback(BarcodeView.Callback)
     */
    public void decodeContinuous(BarcodeView.Callback callback) {
