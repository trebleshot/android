...
interface PerformerCallback {
    /**
     * Invoked when the selection state of a model is about to change. By returning false, it can be stopped from
     ...
     * @param owner      That is making the call to alter the selection state of the [SelectionModel].
     * @param selectionModel Whose state is being altered.
     ...
     * @param engine     That is holding an instance of this class.
     * @param owner      That is making the call to alter the selection state of the [SelectionModel].
     * @param selectionModelList Whose states are being altered.
     * @param isSelected     To be set.
